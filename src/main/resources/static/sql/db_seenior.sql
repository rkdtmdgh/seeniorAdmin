...
CREATE TABLE MEALPROVIDER(
	M_NO		INT AUTO_INCREMENT COMMENT "식단 NO(PK)",
    M_RCP_SEQ	INT NOT NULL COMMENT "일련번호",
    M_RCP_NM	VARCHAR(255) NOT NULL COMMENT "메뉴명",
    M_RCP_WAY2	VARCHAR(255) NOT NULL COMMENT "조리 방법",
    M_RCP_PAT2 VARCHAR(255) NOT NULL COMMENT "요리 종류",
    M_INFO_WGT INT COMMENT "중량(1인분)",
    M_INFO_ENG INT COMMENT "열량",
    M_INFO_CAR INT COMMENT "탄수화물",
    M_INFO_PRO INT COMMENT "단백질",
    M_INFO_FAT INT COMMENT "지방",
    M_INFO_NA INT COMMENT "나트륨",
    M_HASH_TAG VARCHAR(255) COMMENT "해쉬 태그",
    M_ATT_FILE_NO_MAIN VARCHAR(255) COMMENT "이미지 경로(소)",
    M_ATT_FILE_NO_MK VARCHAR(255) COMMENT "이미지 경로(대)",
    M_RCP_PARTS_DTLS TEXT COMMENT "재료 정보",
    M_MANUAL01 TEXT COMMENT "만드는법_01",
    M_MANUAL_IMG01 VARCHAR(255) COMMENT "만드는법_이미지_01",
    M_MANUAL02 TEXT COMMENT "만드는법_02",
    M_MANUAL_IMG02 VARCHAR(255) COMMENT "만드는법_이미지_02",
    M_MANUAL03 TEXT COMMENT "만드는법_03",
    M_MANUAL_IMG03 VARCHAR(255) COMMENT "만드는법_이미지_03",
    M_MANUAL04 TEXT COMMENT "만드는법_04",
    M_MANUAL_IMG04 VARCHAR(255) COMMENT "만드는법_이미지_04",
    M_MANUAL05 TEXT COMMENT "만드는법_05",
    M_MANUAL_IMG05 VARCHAR(255) COMMENT "만드는법_이미지_05",
    M_MANUAL06 TEXT COMMENT "만드는법_06",
    M_MANUAL_IMG06 VARCHAR(255) COMMENT "만드는법_이미지_06",
    M_MANUAL07 TEXT COMMENT "만드는법_07",
    M_MANUAL_IMG07 VARCHAR(255) COMMENT "만드는법_이미지_07",
    M_MANUAL08 TEXT COMMENT "만드는법_08",
    M_MANUAL_IMG08 VARCHAR(255) COMMENT "만드는법_이미지_08",
    M_MANUAL09 TEXT COMMENT "만드는법_09",
    M_MANUAL_IMG09 VARCHAR(255) COMMENT "만드는법_이미지_09",
    M_MANUAL10 TEXT COMMENT "만드는법_10",
    M_MANUAL_IMG10 VARCHAR(255) COMMENT "만드는법_이미지_10",
    M_MANUAL11 TEXT COMMENT "만드는법_11",
    M_MANUAL_IMG11 VARCHAR(255) COMMENT "만드는법_이미지_11",
    M_MANUAL12 TEXT COMMENT "만드는법_12",
    M_MANUAL_IMG12 VARCHAR(255) COMMENT "만드는법_이미지_12",
    M_MANUAL13 TEXT COMMENT "만드는법_13",
    M_MANUAL_IMG13 VARCHAR(255) COMMENT "만드는법_이미지_13",
    M_MANUAL14 TEXT COMMENT "만드는법_14",
    M_MANUAL_IMG14 VARCHAR(255) COMMENT "만드는법_이미지_14",
    M_MANUAL15 TEXT COMMENT "만드는법_15",
    M_MANUAL_IMG15 VARCHAR(255) COMMENT "만드는법_이미지_15",
    M_MANUAL16 TEXT COMMENT "만드는법_16",
    M_MANUAL_IMG16 VARCHAR(255) COMMENT "만드는법_이미지_16",
    M_MANUAL17 TEXT COMMENT "만드는법_17",
    M_MANUAL_IMG17 VARCHAR(255) COMMENT "만드는법_이미지_17",
    M_MANUAL18 TEXT COMMENT "만드는법_18",
    M_MANUAL_IMG18 VARCHAR(255) COMMENT "만드는법_이미지_18",
    M_MANUAL19 TEXT COMMENT "만드는법_19",
    M_MANUAL_IMG19 VARCHAR(255) COMMENT "만드는법_이미지_19",
    M_MANUAL20 TEXT COMMENT "만드는법_20",
    M_MANUAL_IMG20 VARCHAR(255) COMMENT "만드는법_이미지_20",
    M_RCP_NA_TIP TEXT COMMENT "저감 조리법 TIP",
    PRIMARY KEY(M_NO)
);

SELECT * FROM MEALPROVIDER;
SHOW INDEX FROM PRESCRIPTIONS;
DROP TABLE PRESCRIPTIONS;
